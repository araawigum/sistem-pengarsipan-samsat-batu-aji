...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 08 Jul 2026 pada 05.52
...
(13, 'MUhammad Brahma Panca Buana', 'brahmagoat', 'brahma123', '');
...
(19, 'Fajar Hidayat', '2171120407950044', 'Perumahan Marina Residence Blok B2 No. 15, Batam', '081234567804'),
...
ALTER TABLE `kendaraan`
  ...
  ADD UNIQUE KEY `uk_no_polisi` (`no_polisi`);
...
ALTER TABLE `wajib_pajak`
  ...
  ADD UNIQUE KEY `uk_no_ktp` (`no_ktp`);
...
--
ALTER TABLE `wajib_pajak`
  MODIFY `id_wajib_pajak` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=43;
COMMIT;
